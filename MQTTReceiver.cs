...
public class mqttReceiver : M2MqttUnityClient
{
    ...
    public string topicSubscribe = "cdanh2012/feeds/mqtt-subscribe" ; // topic to subscribe. !!! The multi-level wildcard # is used to subscribe to all the topics. Attention i if #, subscribe to all topics. Attention if MQTT is on data plan
                                                                
    [Tooltip("Set the topic to publish (optional)")]
    public string topicPublish = "cdanh2012/feeds/mqtt-subscribe"; // topic to publish
